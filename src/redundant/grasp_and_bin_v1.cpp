...
//#include <actionlib/include/actionlib/client/simple_action_client.h>
...
bool grasp_and_bin(duplo_notouch_onebin::Grasp_Duplo::Request &req,
                   duplo_notouch_onebin::Grasp_Duplo::Response &res)
{
  ...
  sensor_msgs::PointCloud to_pick;
  object_manipulation_msgs::GraspableObject object;
  if (sensor_msgs::convertPointCloud2ToPointCloud(req.pick_cluster,to_pick) == true)
  {
	object.cluster = to_pick;
  ...
  place_goal.place_locations[0] = place_location;
